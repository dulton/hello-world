...
#define TSC2007_DEBOUNCE_TIME					   120
#define TSC2007_CONTINUOUS_TIME                     100
#define TSC2007_PRESS_LEVEL                         0
#define TSC2007_INIT_VALUE                          1

#define TSC2007_ADC_STEPS						   4095
