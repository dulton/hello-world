...
typedef UINT16  AHC_OS_FLAG_WTYPE;
    #define AHC_OS_FLAG_WAIT_CLR_ALL       	OS_FLAG_WAIT_CLR_ALL
    #define AHC_OS_FLAG_WAIT_CLR_ANY       	OS_FLAG_WAIT_CLR_ANY
    #define AHC_OS_FLAG_WAIT_SET_ALL       	OS_FLAG_WAIT_SET_ALL
    #define AHC_OS_FLAG_WAIT_SET_ANY       	OS_FLAG_WAIT_SET_ANY
    #define AHC_OS_FLAG_CONSUME            	OS_FLAG_CONSUME
    
typedef UINT16  AHC_OS_FLAG_OPT;
    #define AHC_OS_FLAG_CLR                	OS_FLAG_CLR
    #define AHC_OS_FLAG_SET                	OS_FLAG_SET

typedef UINT8   AHC_OS_TMR_OPT;
    #define AHC_OS_TMR_OPT_ONE_SHOT        	OS_TMR_OPT_ONE_SHOT
    #define AHC_OS_TMR_OPT_PERIODIC        	OS_TMR_OPT_PERIODIC
    #define AHC_OS_TMR_OPT_NONE				OS_TMR_OPT_NONE
    #define AHC_OS_TMR_OPT_CALLBACK			OS_TMR_OPT_CALLBACK
