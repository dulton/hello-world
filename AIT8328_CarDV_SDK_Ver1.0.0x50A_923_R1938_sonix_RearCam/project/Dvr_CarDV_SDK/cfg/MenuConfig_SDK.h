...
#define MENU_MOVIE_VMD_REC_TIME_1MIN_EN          	(1)
    ...
    #if (REAR_CAM_TYPE == REAR_CAM_TYPE_NONE) //Mantis_1029756: TIMELAPSE for single cam only.
...
#if (REAR_CAM_TYPE == REAR_CAM_TYPE_NONE) //Mantis_1029756: SLOWMOTION for single cam only
...
#define MENU_MOVIE_HDR_MODE_EN                      (!SNR_CLK_POWER_SAVING_SETTING & 0)
...
#define MENU_PLAYBACK_SLIDESHOW_FILE_EN         	(SLIDESHOW_EN & 0)
