...
@{ */
    ...
    #define VIDRECD_RESOL_MAX_NUM       (21)
    #define VIDRECD_RESOL_160x120       (0)
    #define VIDRECD_RESOL_176x144       (1)
    #define VIDRECD_RESOL_272x144       (2)
    #define VIDRECD_RESOL_320x240       (3)
    #define VIDRECD_RESOL_352x288       (4)
    #define VIDRECD_RESOL_368x208       (5)
    #define VIDRECD_RESOL_480x272       (6)
    #define VIDRECD_RESOL_624x352       (7)
    #define VIDRECD_RESOL_640x368       (8)
    #define VIDRECD_RESOL_640x480       (9)
    #define VIDRECD_RESOL_720x480       (10)
    #define VIDRECD_RESOL_848x480       (11)
    #define VIDRECD_RESOL_912x512       (12)
    #define VIDRECD_RESOL_960x720       (13)
    #define VIDRECD_RESOL_1280x720      (14)
    #define VIDRECD_RESOL_1440x1088     (15)
    #define VIDRECD_RESOL_1920x1088     (16)
    #define VIDRECD_RESOL_2304x1296     (17)
    #define VIDRECD_RESOL_2704x1536     (18)
    #define VIDRECD_RESOL_3840x2160     (19)
    #define VIDRECD_RESOL_2560x1440     (20)
