...
#define BIND_SENSOR_OV4689_2LINE		(1)
...
#define SPEAKER_ENABLE_GPIO             (MMP_GPIO63) // CGPIO31 -->> SPK_Shutdown
...
#define WAIT_CHECK_BDEVICE_CONN_INTERVAL    (800)
...
#define ADC_KEY_VOLT_U              (ADC_KEY_BOARD_TYPE)? (3290):(200)      // 200mV
#define ADC_KEY_VOLT_D              (ADC_KEY_BOARD_TYPE)? (1377):(2200)     // 2220mV
#define ADC_KEY_VOLT_L              (ADC_KEY_BOARD_TYPE)? (925):(ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_R              (ADC_KEY_BOARD_TYPE)? (470):(ADC_KEY_VOLT_DEFAULT)

#define ADC_KEY_VOLT_ENTER			(ADC_KEY_VOLT_DEFAULT)
#if (MORE_ADC_KEY==1)
#define ADC_KEY_VOLT_REC  			(ADC_KEY_BOARD_TYPE)? (2838):(890)
#define ADC_KEY_VOLT_MENU   		(ADC_KEY_BOARD_TYPE)? (1880):(ADC_KEY_VOLT_DEFAULT)  	
#define ADC_KEY_VOLT_PLAY   		(ADC_KEY_VOLT_DEFAULT) 
#define ADC_KEY_VOLT_MODE   		(ADC_KEY_BOARD_TYPE)? (2335):(1629)
...
#define KEY_GPIO_REC                (MMP_GPIO27)   // BGPIO18 -->> SHUTTER_KEY
#define KEY_GPIO_MENU               (MMP_GPIO_MAX)   // BGPIO20 -->> MENU_KEY
#define KEY_GPIO_PLAY 				(MMP_GPIO_MAX)
#define KEY_GPIO_MODE               (MMP_GPIO29)   // BGPIO21 -->> MODE_KEY
#define KEY_GPIO_POWER              (MMP_GPIO40)   // CGPIO8 -->> PWR_KEY
#define KEY_GPIO_CIRCLE 			(MMP_GPIO_MAX)
#if (MORE_GPIO_KEY == 1)
#define KEY_GPIO_UP                 (MMP_GPIO30)   // BGPIO17 -->> UP_KEY
#define KEY_GPIO_DOWN               (MMP_GPIO28)   // BGPIO19 -->> DOWN_KEY
...
#define KEY_PRESSLEVEL_POWER        LEVEL_HIGH

#define KEY_PRESSLEVEL_UP           LEVEL_HIGH
