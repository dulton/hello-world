 ...
 * PCBA config file
 */
#ifndef	__CONFIG_SDK_ALONG__
#define	__CONFIG_SDK_ALONG__
...
//--------------------------------------------------
#if WIFI_PORT == 1
#define NCFG_WAKEUP_PIN   (MMP_GPIO42)     // CGPIO10
#define NCFG_RESET_PIN    (MMP_GPIO53)     // CGPIO21
#else
#define NCFG_WAKEUP_PIN   (MMP_GPIO_MAX)
#define NCFG_RESET_PIN    (MMP_GPIO_MAX)
#endif

#define NCFG_SDIO_PAD     2
// Special WIFI-MFG mode, should NOT be enabled normally !!!
//--------------------------------------------------
#ifndef NCFG_WIFI_MFG_EN
#define NCFG_WIFI_MFG_EN  0                 // defined in MCP
#endif

#define AHC_WIFI_VERSION                     "V0.06.00"

//#define CFG_DRAW_WIFI_STREAMING_MONO_PATTERN	(GUI_TRANSPARENT | GUI_BLUE)
...
#define GSENSOR_INT_LEVEL			GPIO_LOW
...
#if (GSENSOR_MODULE==GSENSOR_MODULE_LIS3DH)	//FcrPm 3:50:16 2015-10-22
	#define GSENSOR_LIS3DE_SUPPORT					//for costdown Gsensor
#endif
...
#define	GSNR_SENS_5LEVEL4			GR(1.0)
...
#define GSENSOR_INT                 (MMP_GPIO99)   // PI2S_SDI
	#ifdef GSENSOR_LIS3DE_SUPPORT	//FcrPm 2:31:55 2015-10-28
		#define	POWER_ON_GSNR_SENS_LEVEL0	GR(0.15)
		#define	POWER_ON_GSNR_SENS_LEVEL1	GR(0.25)
		#define	POWER_ON_GSNR_SENS_LEVEL2	GR(0.50)
	#else
...
#define GSNR_PWRON_MOVIE_SHAKED_ACT	GSNR_PWRON_MOVIE_LOCKED//Lock file or not after GSNR powering on 

#define POWER_ON_GSNR_MOVIE_TIME	(10)//Uint: sec
#define POWER_ON_GSNR_IDLE_TIME		(10)//Uint: sec
#endif

#define CUS_GSENSOR_INT_CFG_SETTING         1
...
#if (GSENSOR_MODULE == GSENSOR_MODULE_LIS3DH)
	#ifdef GSENSOR_LIS3DE_SUPPORT
	#define GSENSOR_SLAVE_ADDR		(0x29)			// LIS3DE
	#else
	#define GSENSOR_SLAVE_ADDR		(0x19)			// LIS3DH, default is 0x19
	#endif
//	#define GSENSOR_SLAVE_ADDR		(0x28)			// LIS3DE
...
#define GPS_MODULE_EN_GPIO			(MMP_GPIO52)//(MMP_GPIO_MAX)
...
//#define VR_VIDEO_TYPE_SETTING       (COMMON_VR_VIDEO_TYPE_SETTING_H264ENC_HIGH_PROFILE)
...
/* For WIFI enabled project, support AAC only*/
#undef VR_AUDIO_TYPE
...
/* Bitrate Setting */
// For WIFI
#define VR_BITRATE_SHD30P_SUPER     (16000000)
#define VR_BITRATE_SHD30P_FINE      ( 8000000)
#define VR_BITRATE_FHD60P_SUPER     (32000000)
#define VR_BITRATE_FHD60P_FINE      (16000000)
#define VR_BITRATE_FHD30P_SUPER     (16000000)
#define VR_BITRATE_FHD30P_FINE      ( 8000000)
#define VR_BITRATE_HD30P_SUPER      (12000000)
#define VR_BITRATE_HD30P_FINE       ( 8000000)
...
#define CHARGE_FULL_NOTIFY			        (1)	//FcrAm 10:44:52 2015-11-5 0->1
...
#define CHARGER_IN_ACT_VIDEO_MODE	        (ACT_NONE)
...
#define DEVICE_GPIO_DC_INPUT          (MMP_GPIO25)       // BGPIO15
...
#define USB_IN_DETECT_VBUS_PIN              (MMP_GPIO51)//B15
#define USB_IN_DETECT_VBUS_PIN_ACTIVE       (GPIO_LOW)
#define USB_DETECTION_CUSTOM (0) //TBD
#define USB_OUT_PWR_SW_PIN                  (MMP_GPIO50)//B8
...
#define HDMI_MENU_EN				(HDMI_ENABLE & 0)
...
#define TV_OUT_DETECT_GPIO          (MMP_GPIO26)   // BGPIO16
...
#define QUICK_EDIT_BROWSER_FILE		(QUICK_EDIT_DISABLE)

#define QUICK_FILE_EDIT_EN			(0) 

#define QUICK_FORMAT_SD_EN			(0) 

#define UI_MODE_SELECT_EN			(0)
...
#define DSC_TOUCH_PANEL                         (TOUCH_PANEL_FT6X36)//(TOUCH_PANEL_ZT2003)
#define TOUCH_PANEL_INT_GPIO                    (MMP_GPIO59)
#define TOUCH_PANEL_USE_INTR_MODE               (1)
#endif
...
*/
#define ADC_KEY_EN                  (1)
#define MORE_ADC_KEY				(1)		//0 to 1,SMC change at 2015-10-23 update
#define ADC_KEY_SARADC_CHANNEL      (1)

#define ADC_KEY_VOLT_U  		(200)	//540//(1600) //FcrPm 12:56:24 2015-10-28
#define ADC_KEY_VOLT_D   		(1625)	//0//(2430)  		//FcrPm 12:56:35 2015-10-28
#define ADC_KEY_VOLT_L   		(ADC_KEY_VOLT_DEFAULT)//(ADC_KEY_VOLT_DEFAULT) 
#define ADC_KEY_VOLT_R   		(ADC_KEY_VOLT_DEFAULT)

#define ADC_KEY_VOLT_ENTER			(ADC_KEY_VOLT_DEFAULT)	//360//(ADC_KEY_VOLT_DEFAULT),ad=316
#if (MORE_ADC_KEY==1)
#define ADC_KEY_VOLT_REC  			(1022)	//(535) SMC update at 2015-10-23
#define ADC_KEY_VOLT_MENU   		(ADC_KEY_VOLT_DEFAULT)  	
#define ADC_KEY_VOLT_PLAY   		(ADC_KEY_VOLT_DEFAULT) 
#define ADC_KEY_VOLT_MODE   		(0)//(1300)//(0)//(678)					//(ADC_KEY_VOLT_DEFAULT) //FcrPm 12:57:04 2015-10-28
...
#define ADC_STATE_ID_MODE           (ADCPRESS_MODE) // (ADCPRESS_NONE)
...
#define ADC_KEY_VOLT_MARGIN		(50)	//(100)	//FcrPm 12:09:06 2015-10-28
#define ADC_KEY_LONG_PRESS_CNT 		(4)
#define ADC_KEY_STABLE_CNT                  (2)
...
#define KEY_GPIO_MODE               (MMP_GPIO_MAX)   //(MMP_GPIO82) 	// MIPI_RX1_DA2P 	-->> MODE_KKEY
#define KEY_GPIO_POWER 				(MMP_GPIO40)//(MMP_GPIO_MAX)//(MMP_GPIO40) 	// CGPIO8 			---> PWR_KEY_IN
...
#define KEY_PRESSLEVEL_POWER		LEVEL_LOW//LEVEL_HIGH
...
#else
#define BATTERY_DETECTION_EN            (1)
#endif

#define BATTERY_LOW_BOOT_VOLT		    (3600)
#define BATTERY_VOLTAGE_OFFSET		    (110)
#define BATT_FULL_LEVEL				    (4100)	//(3782) //FcrAm 11:13:55 2015-11-5
#define BATT_LEVEL_2				    		(3950)	//(3618) //FcrAm 11:13:58 2015-11-5,3950=3.9V
#define BATT_LEVEL_1				    		(3750)	//(3536) //FcrAm 11:14:00 2015-11-5,3770=3.7V,3862=3.8V
#define BATT_LEVEL_0				    		(3600)	//(3450) //FcrAm 11:14:02 2015-11-5.3680=3.6v,3600=3.5V
...
#define	CFG_BOOT_BYPASS_CLOCK_CHECK	(1)
/*===========================================================================
 *  ADAS setting
 *===========================================================================*/
