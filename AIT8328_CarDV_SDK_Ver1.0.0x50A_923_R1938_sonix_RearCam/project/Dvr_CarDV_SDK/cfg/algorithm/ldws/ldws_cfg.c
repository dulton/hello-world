...
//
//==============================================================================
extern MMP_ERR MMPS_3GPRECD_GetPreviewSize(MMP_UBYTE ubSnrSel, MMP_ULONG *width, MMP_ULONG *height);
...
void LDWS_CalibrationParam_Convert(ldws_tuning_params menu_ldws_tuning_params)
{
    ...
    MMPS_3GPRECD_GetPreviewSize(PRM_SENSOR, &width, &height);
...
MMP_ERR LDWS_CalibrationParam_Read(void)
{
	...
	printc("Setup Pos        : %d\r\n\r\n", ldwsSetupPosi);
    printc("====End of ADAS Parameter Read %s====\r\n");
    #endif
	return err;
}
