 ...
 * PCBA config file
 */
#ifndef _CONFIG_SDK_HSG_H_
#define _CONFIG_SDK_HSG_H_
...
#define AIT_HW_WATCHDOG_ENABLE (0) //(1)
...
#define LCD_GPIO_BACK_LIGHT             (MMP_GPIO4)    // AGPIO3 -->> LCD_BL
...
#define LCD_GPIO_ENABLE                 (MMP_GPIO39)
...
#define SENSOR_GPIO_ENABLE              (MMP_GPIO74)
#define SENSOR_GPIO_ENABLE_ACT_LEVEL    (GPIO_LOW)
...
#define GSENSOR_MODULE              (GSENSOR_MODULE_GMA301)
...
//    #define GSENSOR_SLAVE_ADDR      (0x28)          // LIS3DE, 7-bits mode
    ...
    #define GSENSOR_SLAVE_ADDR      (0x18)          // GMA301, default is 0x18
    #define GSNR_GROUND_AXIS        (X_AXIS)
...
/* Bitrate Setting */
// For WIFI
#define VR_BITRATE_1440_30P_SUPER   (16000000)
#define VR_BITRATE_1440_30P_FINE    ( 8000000)
...
#define CHARGE_FULL_NOTIFY                  (1)
#define CHARGE_FULL_STATUS                  (1)
#define GPIO_CHARGE_STATUS                  (MMP_GPIO68)
...
#define DEVICE_GPIO_DC_INPUT		         (MMP_GPIO25)
...
//#define USB_IN_DETECT_VBUS_PIN              (MMP_GPIO25)//B15  //dc?им2a //2?dc?aж╠ик
//#define USB_IN_DETECT_VBUS_PIN_ACTIVE       (GPIO_LOW)
#define USB_DETECTION_CUSTOM (0) //TBD
#define USB_OUT_PWR_SW_PIN                  (MMP_GPIO6)//B8//(MMP_GPIO52)//C20 //USB??
...
#define TV_OUT_DETECT_GPIO          (MMP_GPIO24)   // BGPIO14
#define DEVICE_GPIO_TV              (TV_OUT_DETECT_GPIO)
#define TV_CONNECTED_STATE          (GPIO_LOW)
#endif
...
#define LED_GPIO_VIDEO                          (MMP_GPIO5)
...
#define CHARGER_STATUS                          (MMP_GPIO68)    //Input mode
#define CHARGER_STATUS_ACT_LEVEL                (GPIO_HIGH)
...
#define ADC_KEY_VOLT_U              (2040)
#define ADC_KEY_VOLT_D              (1016)
#define ADC_KEY_VOLT_L              (ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_R              (ADC_KEY_VOLT_DEFAULT)


//1238 200 1800 2180 2429

//#define ADC_KEY_VOLT_ENTER          1600//(ADC_KEY_VOLT_DEFAULT)
#define ADC_KEY_VOLT_ENTER          (1629)
#if (MORE_ADC_KEY==1)
#define ADC_KEY_VOLT_REC         (2506)  //   (1625)   
#define ADC_KEY_VOLT_MENU   		(1625) //(2506)  	
#define ADC_KEY_VOLT_PLAY           (ADC_KEY_VOLT_DEFAULT)
//#define ADC_KEY_VOLT_MODE           (904)    
#define ADC_KEY_VOLT_MODE       (2306) //  (2306)
...
#if (MORE_ADC_KEY==1)
#define ADC_STATE_ID_REC            (ADCPRESS_REC)
...
#define KEY_GPIO_REC 				(MMP_GPIO_MAX) 	// MIPI_RX1_CKP 	-->> OK_KEY
#define KEY_GPIO_MENU 				(MMP_GPIO_MAX) 	// PI2S_SD0 	-->> MENU_KEY
#define KEY_GPIO_PLAY 				(MMP_GPIO_MAX)
#define KEY_GPIO_MODE 				(MMP_GPIO_MAX) 	// MIPI_RX1_DA2P 	-->> B_KKEY
...
#define KEY_GPIO_LEFT 				(MMP_GPIO_MAX) 	// MIPI_RX1_CKN 	-->> LEFT_KEY
#define KEY_GPIO_RIGHT 				(MMP_GPIO_MAX) 	// MIPI_RX1_DA2N 	-->> RIGHT_KEY
...
#define BATT_FULL_LEVEL                 (3802)
#define BATT_LEVEL_2                    (3638)
#define BATT_LEVEL_1                    (3556)
#define BATT_LEVEL_0                    (3470)

// ADC value = VBAT * REAL_BAT_VOLTAGE_RATIO_N / REAL_BAT_VOLTAGE_RATIO_M, mV  //200/480  //200/470
// Dependon PCBA  //2.88
#define REAL_BAT_VOLTAGE_RATIO_N        (6)
...
#define BATTERY_DETECT_ADC_CHANNEL      (0)
