...
#define AIT_HW_WATCHDOG_TIMEOUT (30000) //Unit: ms.  
...
#define POLLING_VBUS_INTERVAL               (200)           //polling VBus interval
#define WAIT_OTG_SESSION_INTERVAL           (50)            //after VBus output HIGH, interval before OTG session
