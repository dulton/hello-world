...
AHC_BOOL MenuItemFaceTouch(PSMENUITEM pItem, AHC_BOOL bIsHover);
AHC_BOOL MenuItemSmileDetection(PSMENUITEM pItem, AHC_BOOL bIsHover);
AHC_BOOL MenuItemSmileSensitivity(PSMENUITEM pItem, AHC_BOOL bIsHover);
...
SMENUITEM sItemFaceTouch            = { ITEMID_FACETOUCH, 			NULL, 						 IDS_DS_FACE_TOUCH,	&sSubFaceTouch, 		0, 	 0, AHC_TRUE, NULL };
#if (MENU_MANUAL_FACE_DETECT_ON_EN)
SMENUITEM sItemFaceTouch_FD         = { ITEMID_FACETOUCH_FD, 		&BMICON_OPTION_OPEN, 	    	IDS_DS_ON,		NULL, 	MenuItemFaceTouch, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MANUAL_FACE_DETECT_TOUCHSPOT_EN)
SMENUITEM sItemFaceTouch_Touchspot  = { ITEMID_FACETOUCH_TOUCHSPOT, &bmIcon_FaceTouch_TouchSpot, IDS_DS_TOUCH_SPOT,		NULL, MenuItemFaceTouch, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MANUAL_FACE_DETECT_OFF_EN)
SMENUITEM sItemFaceTouch_Off        = { ITEMID_FACETOUCH_OFF, 		&BMICON_OPTION_CLOSE, 			IDS_DS_OFF,			NULL, 	MenuItemFaceTouch, 0, AHC_TRUE, NULL };
#endif
#endif

// Smile Detection
#if (MENU_MANUAL_SMILE_DETECT_EN)
SMENUITEM sItemSmileDetection         = { ITEMID_SMILE_DETECTION, NULL, IDS_DS_SMILE_DETECTION,	&sSubSmileDetection, 0, 0, AHC_TRUE, NULL };
#if (MENU_MANUAL_SMILE_DETECT_OFF_EN)
SMENUITEM sItemSmileDetection_Off     = { ITEMID_SMILED_OFF, 	 &bmIcon_Smile_Detection_Off, 	  IDS_DS_OFF,						NULL, MenuItemSmileDetection, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MANUAL_SMILE_DETECT_1PEOPLE_EN)
SMENUITEM sItemSmileDetection_1People = { ITEMID_SMILED_1PEOPLE, &bmIcon_Smile_Detection_1People, IDS_DS_SMILE_DETECTION_1PERSON,	NULL, MenuItemSmileDetection, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MANUAL_SMILE_DETECT_2PEOPLE_EN)
SMENUITEM sItemSmileDetection_2People = { ITEMID_SMILED_2PEOPLE, &bmIcon_Smile_Detection_2People, IDS_DS_SMILE_DETECTION_2PERSONS,	NULL, MenuItemSmileDetection, 0, AHC_TRUE, NULL };
#endif
#endif

// Smile Sensitivity
#if (MENU_MANUAL_SMILE_SEN_EN)
SMENUITEM sItemSmileSensitivity       = { ITEMID_SMILE_SENSITIVITY,  NULL, IDS_DS_SMILE_SENSITIVITY,	&sSubSmileSensitivity, 0, 0, AHC_TRUE, NULL };
#if (MENU_MANUAL_SMILE_SEN_LOW_EN)
SMENUITEM sItemSmileSensitivity_Low   = { ITEMID_SMILE_SENSITI_LOW,  NULL, IDS_DS_LOW,	NULL, MenuItemSmileSensitivity, 0, AHC_TRUE, NULL };
#endif
#if (MENU_MANUAL_SMILE_SEN_HIGH_EN)
SMENUITEM sItemSmileSensitivity_High  = { ITEMID_SMILE_SENSITI_HIGH, NULL, IDS_DS_HIGH,	NULL, MenuItemSmileSensitivity, 0, AHC_TRUE, NULL };
#endif
#endif
...
#if (MENU_MANUAL_FACE_DETECT_EN)
PSMENUITEM   sMenuListFaceTouch[] =
{
#if (MENU_MANUAL_FACE_DETECT_ON_EN)
    &sItemFaceTouch_FD,
#endif
#if (MENU_MANUAL_FACE_DETECT_TOUCHSPOT_EN)
    &sItemFaceTouch_Touchspot,
#endif
#if (MENU_MANUAL_FACE_DETECT_OFF_EN)
    &sItemFaceTouch_Off,
#endif
...
#if (MENU_MANUAL_SMILE_DETECT_EN)
PSMENUITEM   sMenuListSmileDetection[] =
{
#if (MENU_MANUAL_SMILE_DETECT_OFF_EN)
    &sItemSmileDetection_Off,
#endif
#if (MENU_MANUAL_SMILE_DETECT_1PEOPLE_EN)
    &sItemSmileDetection_1People,
#endif
#if (MENU_MANUAL_SMILE_DETECT_2PEOPLE_EN)
    &sItemSmileDetection_2People
#endif
};
#endif

#if (MENU_MANUAL_SMILE_SEN_EN)
PSMENUITEM   sMenuListSmileSensitivity[] =
{
#if (MENU_MANUAL_SMILE_SEN_LOW_EN)
	&sItemSmileSensitivity_Low,
#endif
#if (MENU_MANUAL_SMILE_SEN_HIGH_EN)
    &sItemSmileSensitivity_High
#endif
};
#endif
...
SMENUSTRUCT sSubFaceTouch =
{
    ...
    NULL,
    sizeof(sMenuListFaceTouch)/sizeof(PSMENUITEM),
    sMenuListFaceTouch,
    SubMenuEventHandler,
    MenuGetDefault_ManualSetting,
    0,
...
SMENUSTRUCT sSubSmileDetection =
{
    ...
    NULL,
    sizeof(sMenuListSmileDetection)/sizeof(PSMENUITEM),
    sMenuListSmileDetection,
    SubMenuEventHandler,
    MenuGetDefault_ManualSetting,
    0,
...
SMENUSTRUCT sSubSmileSensitivity =
{
    ...
    NULL,
    sizeof(sMenuListSmileSensitivity)/sizeof(PSMENUITEM),
    sMenuListSmileSensitivity,
    SubMenuEventHandler,
    MenuGetDefault_ManualSetting,
    0,
...
AHC_BOOL MenuItemFaceTouch(PSMENUITEM pItem, AHC_BOOL bIsHover)
{
    MenuSettingConfig()->uiFaceTouch = pItem->iItemId - ITEMID_FACETOUCH-1;

	#if (MENU_MANUAL_FACE_DETECT_EN)
	if(pItem->iItemId == ITEMID_FACETOUCH_FD)
	{
		AHC_SetFaceDetection(MenuSettingConfig()->uiFaceTouch);
		AHC_SetAeMeteringMode(AHC_AE_METERING_ACTIVE_SPOT);
	}
	#endif
	#if (MENU_MANUAL_FACE_DETECT_OFF_EN)
	else if(pItem->iItemId == ITEMID_FACETOUCH_OFF)
	{
		AHC_SetFaceDetection(MenuSettingConfig()->uiFaceTouch);
	}
	#endif
	#if (MENU_MANUAL_FACE_DETECT_TOUCHSPOT_EN)
	else if(pItem->iItemId == ITEMID_FACETOUCH_TOUCHSPOT)
	{
		AHC_SetAeMeteringMode(AHC_AE_METERING_ACTIVE_SPOT);
	}
	#endif
	else
		printc("Not supported now. \n");
...
AHC_BOOL MenuItemSmileDetection(PSMENUITEM pItem, AHC_BOOL bIsHover )
{
    MenuSettingConfig()->uiSmileDetect = pItem->iItemId - ITEMID_SMILE_DETECTION-1;
    return AHC_TRUE;
}
#endif
...
AHC_BOOL MenuItemSmileSensitivity(PSMENUITEM pItem, AHC_BOOL bIsHover )
{
    MenuSettingConfig()->uiSmileSensitivity = pItem->iItemId - ITEMID_SMILE_SENSITIVITY-1;
    return AHC_TRUE;
}
#endif
...
#endif
#if (MENU_MANUAL_FACE_DETECT_EN)
        case MENUID_SUB_MENU_FACE_TOUCH:
            DefaultValue = MenuSettingConfig()->uiFaceTouch;
            break;
#endif
#if (MENU_MANUAL_SMILE_DETECT_EN)
        case MENUID_SUB_MENU_SMILE_DETECTION:
            DefaultValue = MenuSettingConfig()->uiSmileDetect;
            break;
#endif
#if (MENU_MANUAL_SMILE_SEN_EN)
        case MENUID_SUB_MENU_SMILE_SENSITIVITY:
            DefaultValue = MenuSettingConfig()->uiSmileSensitivity;
            break;
#endif
#if (MENU_MANUAL_CONTRAST_EN || MENU_STILL_CONTRAST_EN || MENU_MOVIE_CONTRAST_EN)
