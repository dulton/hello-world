...
//
//  File        : MenuSetting.h
//  Description : INCLUDE File for the Menu Seting function porting.
//  Author      :
//  Revision    : 1.0
//
//==============================================================================
...
typedef enum{
    ...
    SMILE_DETECT_1PEOPLE,
#endif
#if (MENU_MANUAL_SMILE_DETECT_2PEOPLE_EN)
    SMILE_DETECT_2PEOPLE,
#endif
    ...
    SMILE_DETECT_2PEOPLE,
#endif
    SMILE_DETECT_DEFAULT = 0
}SMILEDETECTION_SETTING;
...
typedef enum{
    ...
    FACE_DETECT_DEFAULT = 0
}FACEDETECTION_SETTING;
