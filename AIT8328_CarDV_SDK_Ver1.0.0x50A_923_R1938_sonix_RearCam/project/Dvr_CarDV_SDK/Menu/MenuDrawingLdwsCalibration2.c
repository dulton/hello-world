...
void User_LDWS_CalibrationParam_Convert(void)	
{
    ...
    ADASfcwsTuningParms.CalibrationStarY = LDWS_HEIGHT * ADASfcwsTuningParms.CalibrationStarY / ulPreview_height;
    ADASfcwsTuningParms.CalibrationEndY = LDWS_HEIGHT * ADASfcwsTuningParms.CalibrationEndY / ulPreview_height;
	...
	MMPS_ADAS_CustomerCalibration(ADASfcwsTuningParms.CalibrationStarY,ADASfcwsTuningParms.CalibrationEndY);	
...
void User_LDWS_CalibrationParam_Inverse(void)
{
    ...
    //OSD
    OSDfcwsTuningParms.CalibrationStarY = ADASfcwsTuningParms.CalibrationStarY * ulPreview_height / LDWS_HEIGHT;
	OSDfcwsTuningParms.CalibrationEndY  = ADASfcwsTuningParms.CalibrationEndY  * ulPreview_height / LDWS_HEIGHT;
...
void Menudraw_UserLdwsCalibrationIcon(UINT16 bID0)
{
	...
	#else
	AHC_OSDSetColor(OSD_COLOR_DARKGRAY2);
	#endif
