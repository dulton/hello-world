...
#define  OS_VERSION                 281u                /* Version of uC/OS-II (Vx.yy mult. by 100)    */
...
//[jerry]
#define  OS_TASK_OPT_CPU_ARM    0x0000
#define  OS_TASK_OPT_CPU_THUMB  0x0010
//[jerry]
...
*********************************************************************************************************
*/
#define  OS_TMR_OPT_NONE              1u    /* No option selected                                      */

#define  OS_TMR_OPT_ONE_SHOT          2u    /* Timer will not automatically restart when it expires    */
#define  OS_TMR_OPT_PERIODIC          3u    /* Timer will     automatically restart when it expires    */

#define  OS_TMR_OPT_CALLBACK          4u    /* OSTmrStop() option to call 'callback' w/ timer arg.     */
#define  OS_TMR_OPT_CALLBACK_ARG      5u    /* OSTmrStop() option to call 'callback' w/ new   arg.     */
...
#define OS_ERR_TMR_INVALID_PERIOD   170u
#define OS_ERR_TMR_INVALID_OPT      171u
#define OS_ERR_TMR_INVALID_NAME     172u
#define OS_ERR_TMR_NON_AVAIL        173u
#define OS_ERR_TMR_INACTIVE         174u
#define OS_ERR_TMR_INVALID_DEST     175u
#define OS_ERR_TMR_INVALID          176u
#define OS_ERR_TMR_ISR              177u
...
typedef  struct  os_tmr {
    ...
    BOOLEAN          OSTmrActive;                     /* Indicates whether timer is active or not                      */
} OS_TMR;
...
#if OS_TMR_EN > 0
#if OS_TMR_CFG_NAME_SIZE > 0
void         OSTmrGetName(OS_TMR *ptmr, INT8U *pdest, INT8U *perr);
#endif
INT32U       OSTmrGetRemain(OS_TMR *ptmr, INT8U *perr);

OS_TMR      *OSTmrStart(INT32U period, INT8U opt, OS_TMR_CALLBACK callback, void *callback_arg, INT8U *name, INT8U *perr);

void         OSTmrStop(OS_TMR *ptmr, INT8U opt, void *callback_arg, INT8U *perr);
