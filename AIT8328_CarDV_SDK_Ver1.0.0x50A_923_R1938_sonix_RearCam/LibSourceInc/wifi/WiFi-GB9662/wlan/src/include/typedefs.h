...
#define TYPEDEF_BOOL
	...
	!defined(TARGETOS_nucleus) && !defined(TARGETOS_ucOS)
#define TYPEDEF_UINT
#define TYPEDEF_USHORT
#endif
...
#if !defined(__DJGPP__) && !defined(__BOB__) && !defined(TARGETOS_nucleus) && !defined(TARGETOS_ucOS)
