...
typedef struct _AITS_DSPY {
    ...
    AIT_REG_W   DSPY_CTL_2;                                             // 0x0002
        ...
        #define TV_FIELD_SYNC_EN            0x0040
    ...
    AIT_REG_W   DSPY_PLCD_CTL;                                          // 0x0030
        ...
        #define PLCD_68SYS_RC_LOW       	0x0000
        ...
        #define LCD_SPI1_PL2				0x0000 //[Reserved:ShouldNotToRemoved]
        #define LCD_PL1_SPI2                0x0100 //[Reserved:ShouldNotToRemoved]
        #define LCD_PL1_PL2                 0x0200 //[Reserved:ShouldNotToRemoved]
        #define LCD_SPI1_SPI2               0x0300 //[Reserved:ShouldNotToRemoved]
    ...
    AIT_REG_B   DSPY_CTL_4;												// 0x004C
        ...
        /*------------------------------------------------------------*/
    AIT_REG_B   DSPY_OSD_MCI_PORT_SEL;    								// 0x004D
        /*------------------------------------------------------------*/
    ...
    AIT_REG_B   DSPY_WIN_PRIO;											// 0x004E
        /*-DEFINE-----------------------------------------------------*/
        #define WIN_PRIO_MAIN               0x0
        #define WIN_PRIO_PIP                0x1
        #define WIN_PRIO_OVLY               0x2
        #define WIN_PRIO_ICON               0x3
        #define WIN_1_SHFT                  0
        #define WIN_2_SHFT                  2
        #define WIN_3_SHFT                  4
        #define WIN_4_SHFT                  6
        ...
        /*------------------------------------------------------------*/
    AIT_REG_B   DSPY_WIN_BIND_SEL;    									// 0x004F
        /*-DEFINE-----------------------------------------------------*/
        #define MAIN_WIN_SHIFT              0x06
        #define PIP_WIN_SHIFT              	0x04
        #define OVLY_WIN_SHIFT              0x02
        #define OSD_WIN_SHIFT             	0x00
        #define WIN_BIND_SEL_MASK			0x03
        #define WIN_BIND_SEL_PRM			0x02
        #define WIN_BIND_SEL_SCD			0x01
        /*------------------------------------------------------------*/
    ...
    AIT_REG_B	DSPY_MAIN_DBG_OBS_SEL;									// 0x0148
    AIT_REG_B	DSPY_MAIN_FIFO_MAX_CTL;									// 0x0149
    AIT_REG_B                           _x014A[0x2];
    AIT_REG_B   DSPY_MAIN_DBG_SEL_BYTE[4];								// 0x014C
    ...
    AIT_REG_W   DSPY_MAIN_CTL;                                  		// 0x0160
		...
		#define WIN_DATA_RGB            	0x0000
        #define WIN_DATA_BGR            	0x0040
    ...
    AIT_REG_W   DSPY_MAIN_CTL_2;                              			// 0x0162
        ...
        #define WIN_V_3X                    0x0003
        #define WIN_V_4X                    0x0004
        #define WIN_V_5X                    0x0005
        #define WIN_V_6X                    0x0006

        #define WIN_H_1X                    0x0008
        #define WIN_H_2X                    0x0010
        #define WIN_H_3X                    0x0018
        #define WIN_H_4X                    0x0020
        #define WIN_H_5X                 	0x0028
        #define WIN_H_6X                 	0x0030

		#define WIN_V_DIV_2              	0x0040
		#define WIN_H_DIV_2             	0x0080

        #define WIN_V_DUP_MASK				0x0047
        #define WIN_H_DUP_MASK				0x00B8
        #define WIN_V_DUP_MASK1				0x0007
        #define WIN_H_DUP_MASK1				0x0038
        #define WIN_DUP_MASK				0x00FF
    ...
    AIT_REG_W   DSPY_MAIN_FMT;											// 0x0164
        ...
        #define WIN_24BPP                   0x0008	// MAIN, PIP, OSD, OVLY
	...
	AIT_REG_W   DSPY_MAIN_WIDTH_DUP_DIV;								// 0x017A
	AIT_REG_D   DSPY_MAIN_PIXL_CNT_DUP_DIV;								// 0x017C
    ...
    AIT_REG_W   DSPY_SCD_CTL;						                    // 0x01A0
        /*-DEFINE-----------------------------------------------------*/
        // Ref: DSPY_CTL_0
        #define SW_UPDATE_SCD_OPR_NOW		0x0100
        /*------------------------------------------------------------*/
    ...
    AIT_REG_B                           _x01CC[0x4];
    
    AIT_REG_B                           _x01D0[0x10];
    ...
    AIT_REG_B	DSPY_PIP_DBG_OBS_SEL;									// 0x0248
    AIT_REG_B	DSPY_PIP_FIFO_MAX_CTL;									// 0x0249
    AIT_REG_B                           _x024A[0x2];
    AIT_REG_B   DSPY_PIP_DBG_SEL_BYTE[4];								// 0x024C
	...
	AIT_REG_W   DSPY_PIP_WIDTH_DUP_DIV;									// 0x027A
	AIT_REG_D   DSPY_PIP_PIXL_CNT_DUP_DIV;								// 0x027C
    ...
    AIT_REG_W   DSPY_PIP_SCAL_V_M;										// 0x028A
        /*-DEFINE-----------------------------------------------------*/
        #define DSPY_SCAL_NM_MAX       		0x007F
        /*------------------------------------------------------------*/
    ...
    AIT_REG_B   DSPY_WBACK_CTL;                             			// 0x03D0
        /*-DEFINE-----------------------------------------------------*/
        #define WBACK_WITHOUT_REFRESH      	0x10
	...
	AIT_REG_B	DSPY_OSD_DBG_OBS_SEL;									// 0x0448			    
    AIT_REG_B	DSPY_OSD_FIFO_MAX_CTL;									// 0x0449			
    AIT_REG_B                           _x044A[0x2];    
    AIT_REG_B   DSPY_OSD_DBG_SEL_BYTE[4];								// 0x044C
    ...
    AIT_REG_W   DSPY_OSD_GLOBAL_ALPHA_WT;								// 0x0472
	AIT_DSPY_TP DSPY_OSD_TP;											// 0x0474
	AIT_REG_W   DSPY_OSD_WIDTH_DUP_DIV;									// 0x047A
	AIT_REG_D   DSPY_OSD_PIXL_CNT_DUP_DIV;								// 0x047C
	...
	AIT_REG_B	DSPY_OVLY_DBG_OBS_SEL;									// 0x0548
    AIT_REG_B	DSPY_OVLY_FIFO_MAX_CTL;									// 0x0549
    AIT_REG_B                           _x054A[0x2];    
    AIT_REG_B   DSPY_OVLY_DBG_SEL_BYTE[4];								// 0x054C
    ...
    AIT_REG_W   DSPY_OVLY_GLOBAL_ALPHA_WT;								// 0x0572
...
#define TVENC_MODE_CTL              (TV_BASE  +(MMP_ULONG)(&(((AITPS_TV  )0)->TVENC_MODE_CTL            )))
...
#define TVENC_GAMMA_COEF_1_2          (TV_BASE  +(MMP_ULONG)(&(((AITPS_TV  )0)->TVENC_GAMMA_COEF_1_2        )))
#define TVENC_GAMMA_COEF_3_4          (TV_BASE  +(MMP_ULONG)(&(((AITPS_TV  )0)->TVENC_GAMMA_COEF_3_4        )))
#define TVENC_GAMMA_COEF_5_6          (TV_BASE  +(MMP_ULONG)(&(((AITPS_TV  )0)->TVENC_GAMMA_COEF_5_6        )))
#define TVENC_GAMMA_COEF_7_8          (TV_BASE  +(MMP_ULONG)(&(((AITPS_TV  )0)->TVENC_GAMMA_COEF_7_8        )))
#define TVENC_UV_SCALE_GAIN_4_5     (TV_BASE  +(MMP_ULONG)(&(((AITPS_TV  )0)->TVENC_UV_SCALE_GAIN_4_5   )))
#endif
#endif //(CHIP == MCR_V2)

#endif // _MMP_REG_DISPLAY_H_
