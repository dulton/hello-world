...
#if (CHIP == MCR_V2)
// **********************************************************
//   Audio I2S structure ch0 (0x8000 7800) ch1 (0x8000 5A00) ch2(0x8000 3A00)(MP Only)
// **********************************************************
...
typedef struct _AITS_AUD {
    ...
    AIT_REG_B   AFE_DIG_GAIN_SETTING_CTL;                               //  0x3E
        /*-DEFINE-----------------------------------------------------*/
        #define AFE_DIG_GAIN_SMOOTH_METHOD                  0x08        /*apply for the stage from mute(-60dB) to initial gain setting*/
        #define AFE_DIG_GAIN_DIRECT_METHOD                  0x04        /*apply for the stage from mute(-60dB) to initial gain setting*/
        #define AFE_NORMAL_STATE_DIG_GAIN_DIRECT_METHOD     0x30        /*apply for the stage that if gain has any change after mute to initial gain stage*/
...
//
#if !defined(BUILD_FW)
#define I2S_BASE(ch)            (ch == 0 ? I2S0_BASE : ((ch == 1) ? I2S1_BASE : I2S2_BASE))
#define I2S_CTL(ch)             (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_CTL            )))
#define I2S_BIT_CLT(ch)         (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_BIT_CLT        )))
#define I2S_LRCK_POL(ch)        (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_LRCK_POL       )))
#define I2S_BIT_ALIGN_OUT(ch)   (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_BIT_ALIGN_OUT  )))
#define I2S_BIT_ALIGN_IN(ch)    (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_BIT_ALIGN_IN   )))
#define I2S_MODE_CTL(ch)        (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_MODE_CTL       )))
#define I2S_MCLK_CTL(ch)        (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_MCLK_CTL       )))
#define I2S_DATA_OUT_EN(ch)     (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_DATA_OUT_EN    )))
#define I2S_DATA_IN_SEL(ch)     (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_DATA_IN_SEL    )))
#define I2S_OUT_MODE_CTL(ch)    (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_OUT_MODE_CTL   )))
#define I2S_MUX_MODE_CTL(ch)    (I2S_BASE(ch) +(MMP_ULONG)(&(((AITPS_I2S)0)->I2S_MUX_MODE_CTL   )))
#define AFE_MUX_MODE_CTL        (AUD_BASE     +(MMP_ULONG)(&(((AITPS_AUD)0)->AFE_MUX_MODE_CTL   )))
