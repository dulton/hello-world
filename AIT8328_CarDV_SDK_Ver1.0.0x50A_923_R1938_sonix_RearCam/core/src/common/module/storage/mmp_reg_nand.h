...
typedef struct _AITS_NAND {
	...
	AIT_REG_B	NAD_ECC1;					//0xA005
	AIT_REG_B	NAD_ECC2;					//0xA006
	AIT_REG_B						_x07;
	AIT_REG_B	NAD_ECC3;                   //0xA008
	AIT_REG_B	NAD_ECC4;					//0xA009
	AIT_REG_B	NAD_ECC5;					//0xA00A
	AIT_REG_B						_x0B;
	AIT_REG_D	NAD_DMA_ADDR;				//0xA00C
	
	AIT_REG_W	NAD_DMA_LEN;				//0xA010
	...
	AIT_REG_B	NAD_ADDR_TIMING;			//0xA035
		...
		/*-------------------------------------------*/
	AIT_REG_B	NAD_ADDR[6];				//0xA036
	AIT_REG_W	NAD_TR;						//0xA03C
    AIT_REG_B                       _x3E;
	...
	AIT_REG_D	NAD_ABORT_TIMING;			//0xA050
	AIT_REG_D	NAD_ECC_DMA_ADDR;			//0xA054
	...
	AIT_REG_W	_x60[4];					//0xA060 ~ 67
	AIT_REG_W	_x68[4];					//0xA068 ~ 6F
