...
struct rtp_media {
	...
	rtp_media_close_func       close_frame;
	void *private;
};
...
struct rtp_media *new_rtp_media( rtp_media_get_sdp_func get_sdp,
        rtp_media_get_payload_func get_payload, rtp_media_frame_func proc_frame,
        rtp_media_send_func send_frame, rtp_media_close_func close_frame, void *private );
