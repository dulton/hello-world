...
for wifi_driver.mcp :
Option "LWIP_TX_DMA" must be defined in wifi_driver.mcp if necessary
*/
...
/*Used in LWIP_TX_DMA case*/		
#define LWIP_HEADROOM_SIZE		144
#define LWIP_PAD_SIZE			8
/*
   --------------------------------------------
...
#if defined(LWIP_TX_DMA)
#define PBUF_POOL_BUFSIZE       1536 /* LWIP_MEM_ALIGN_SIZE(TCP_MSS+40+PBUF_LINK_HLEN+LWIP_PAD_SIZE) */
#else
