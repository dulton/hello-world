...
extern const MMPF_STREAM_RING_FORMAT MMP_STREAM_RING_JPEG1;
extern const MMPF_STREAM_RING_FORMAT MMP_STREAM_RING_JPEG2;
extern const MMPF_STREAM_RING_FORMAT MMP_STREAM_RING_AUDIO;
...
MMP_BOOL 	MMPF_FrameRing_AddFrame(MMPF_FRAME_RING_BUF_HANDLE pRing, MMP_ULONG CurSize, MMP_M_STREAMCB_CODEC format, MMP_ULONG time);
...
void 		MMPF_StreamRing_ConfigBuffer(MMP_USHORT usEncID, MMP_ULONG ulBufAddr, MMP_ULONG ulBufSize,
		        						 MMP_USHORT usAlignment, MMP_BOOL bUseDma);
void        MMPF_StreamRing_SetFormat(MMP_USHORT usEncID, MMPF_STREAM_RING_FORMAT format);

// Operation
MMP_LONG    MMPF_StreamRing_AddFrame(MMP_USHORT usEncID, MMP_ULONG size, MMP_ULONG ulTime);
...
AUTL_RINGBUF_HANDLE MMPF_StreamRing_GetBufRing(MMPF_STREAM_RING_ID usEncID);
