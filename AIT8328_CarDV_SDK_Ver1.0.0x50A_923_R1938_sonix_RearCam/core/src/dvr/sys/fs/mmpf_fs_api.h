...
#define MMP_FILEFOLDER_SUMNO   0x0400
#endif
...
#if (FORMAT_FREE_ENABLE)
MMP_ERR MMPF_FS_MakeFileDirEntry(FS_VOLUME * pVolume, const MMP_BYTE *pFileName,MMP_ULONG FileNUM ,MMP_ULONG FileSize, U64 FolderClusterNumber, U64 FileClusterNumber);
...
MMP_ERR MMPF_FORMATFREE_CheckMedia(void);
MMP_ERR MMPF_FORMATFREE_Format(void);
#endif
