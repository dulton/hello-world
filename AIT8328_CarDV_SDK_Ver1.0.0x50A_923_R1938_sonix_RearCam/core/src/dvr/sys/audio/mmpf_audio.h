...
#define FORCE_G711_TRANSCODE        (15)
#define	AAC_AFE_FIFO_READ_THRESHOLD	(192)
...
extern void MMPF_Audio_SetTranscodeUsePlayerInfo(MMP_ULONG samplerate,
                                                 MMP_UBYTE chanum);
extern void MMPF_Audio_TriggerTranscode(MMP_SHORT *pcm, MMP_ULONG count,
                                        MMP_ULONG time);
#endif
