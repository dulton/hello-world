#ifndef	MMPF_STREAM_CTL_H
#define	MMPF_STREAM_CTL_H
...
#define	AV_CHUNK_FOR_READ 	1024
#define	AV_CHUNK_FOR_WRITE 	1024
...
MMP_ERR	MMPF_Audio_TransferDataToCard(MMP_USHORT saveAll);
MMP_ERR	MMPF_Audio_FillBufInterruptToHost(void);

MMP_ERR	MMPF_Audio_InitializeStreaming(void);
...
extern MMP_USHORT	MMPF_SetABRepeatMode(MMP_USHORT command, MMP_ULONG pos);
extern MMP_USHORT	MMPF_PresetMIDIBuf(void); 
extern MMP_USHORT	MMPF_GetDataInterruptToHost(void);
