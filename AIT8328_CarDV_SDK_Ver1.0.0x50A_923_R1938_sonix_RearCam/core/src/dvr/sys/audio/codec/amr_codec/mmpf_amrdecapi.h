...
extern void MMPF_ResumeAMRDec(void);
extern void MMPF_PauseAMRDec(void);
extern void MMPF_StopAMRDec(void);
extern void MMPF_StartAMRDec(void);
extern MMP_ERR MMPF_PreDecAMRFrame(void);
extern void MMPF_DecodeAmrFrame(int decoder);
