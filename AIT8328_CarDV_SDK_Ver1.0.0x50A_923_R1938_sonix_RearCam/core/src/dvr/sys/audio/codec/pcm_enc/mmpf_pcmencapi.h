...
//
//==============================================================================
/*Conifg live input ring buffer that convey RawPCM sample, 
...
/*Conifg live output ring buffer that may convey compressed audio format like G.711/AAC or RawPCM, 
so use byte as unit*/
...
MMP_ERR MMP_LivePCM_AdvanceReadPtr(MMP_ULONG ulSize);
