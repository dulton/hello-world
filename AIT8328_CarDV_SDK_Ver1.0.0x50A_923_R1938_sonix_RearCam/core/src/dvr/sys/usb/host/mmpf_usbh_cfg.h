...
#define DEVICE_TX_YUV_FRAME_SIZE    (gusUsbhMaxYuvWidth*gusUsbhMaxYuvHeight*2)
#endif
#define PREVW_BUF_SIZE              (DEVICE_TX_YUV_FRAME_SIZE) // (0x96000) // (0x25900)
...
//  UVC H264 NALU info
//  descriptions:
//  AIT_H264_SPS_TYPE_OFST: from *UVC_HEADER to H264_SPS_TYPE_HDR, AIT_H264_SPS_SIZE: size of SPS_TYPE w/o start code, 
//  AIT_H264_PPS_TYPE_OFST: from *UVC_HEADER to H264_PPS_TYPE_HDR, AIT_H264_PPS_SIZE: size of PPS_TYPE w/o start code, 
...
#define USBH_EP0_TX_TIMEOUT_CNT             (0x50000)   //(0x10000)     //0x000E8C, ~3724us, 
#define USBH_EP0_RX_TIMEOUT_CNT             (0x2D00000)//(0xF00000)  //0x0DA340, ~893760us
