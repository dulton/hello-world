...
#if DEFAULT_VIDEO_FMT_H264
	#define ENABLE_YUY2
	#define USING_OLD_H264_FILTER       (1)
#else
	#if USB_UVC_SKYPE
		#define ENABLE_YUY2
	#else
...
typedef MMP_ULONG (*MSDC_AIT_SCSI_CUSTOMER_CB) (const MMP_UBYTE *, MMP_UBYTE *);
