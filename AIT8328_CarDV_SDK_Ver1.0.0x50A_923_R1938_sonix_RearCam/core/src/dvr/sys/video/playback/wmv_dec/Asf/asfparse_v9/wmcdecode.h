...
tWMCDecStatus WMCDecSeekToNextIX (HWMCDECODER hWMCDec, U16_WMC wStreamId, short sAdvanced);
tWMCDecStatus WMCDecSeekX (HWMCDECODER hWMCDec, U64_WMC u64TimeRequest, U64_WMC* pu64TimeReturn, tMediaType_WMC SeekType, U8_WMC bNextKey, U8_WMC bNearest, U8_WMC bOnlyAudio);
...
extern U32_WMC WMCDecCBGetDataIndex (
    HWMCDECODER hWMCDec,
    U64_WMC nOffset,
    U32_WMC nNumBytesRequest/*, U32_WMC* pnNumBytesReturn*/,
    U8_WMC *pData,
