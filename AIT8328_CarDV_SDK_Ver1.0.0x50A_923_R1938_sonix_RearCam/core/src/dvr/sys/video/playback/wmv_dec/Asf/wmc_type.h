...
#define FOURCC_WMVP     mmioFOURCC_WMC('W','M','V','P')
...
// MPEG4
#define FOURCC_DIVX     mmioFOURCC_WMC('D','I','V','X')
#define FOURCC_XVID     mmioFOURCC_WMC('X','V','I','D')
#define FOURCC_FMP4     mmioFOURCC_WMC('F','M','P','4')
#define FOURCC_DX50     mmioFOURCC_WMC('D','X','5','0')

// H.263
#define FOURCC_H263     mmioFOURCC_WMC('H','2','6','3')
#define FOURCC_X263     mmioFOURCC_WMC('X','2','6','3')

// H.264
#define FOURCC_H264     mmioFOURCC_WMC('H','2','6','4')
#define FOURCC_X264     mmioFOURCC_WMC('X','2','6','4')
#define FOURCC_h264     mmioFOURCC_WMC('h','2','6','4')
#define FOURCC_x264     mmioFOURCC_WMC('x','2','6','4')
#define FOURCC_avc1     mmioFOURCC_WMC('a','v','c','1')
#define FOURCC_VSSH     mmioFOURCC_WMC('V','S','S','H')
...
#define WAVE_FORMAT_MP3_WMC     0x0055
#define WAVE_FORMAT_AC3_WMC     0x2000
#define WAVE_FORMAT_AAC1_WMC    0x00ff
#define WAVE_FORMAT_AAC2_WMC    0x706d
#define WAVE_FORMAT_AAC3_WMC    0x4143
