...
#define WAVE_FORMAT_RAWPCM    0x0001
#define WAVE_FORMAT_MPEGL3    0x0055
#define WAVE_FORAMT_AC3       0x2000
#define WAVE_FORAMT_AAC1      0x00ff
#define WAVE_FORAMT_AAC2      0x706d
#define WAVE_FORAMT_AAC3      0x4143
