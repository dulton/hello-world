...
*/
#include "wmftypes.h"
//#include "wmaprodecS_api.h"	//20091013
#include "wmcguids.h" 
...
static const WMARESULT WMA_E_ENDOFFILE      = 0x8004000C;
...
typedef struct tAudioStreamInfo
{
    ...
    //samyu@20091117(patch for WMA10Pro)
    U16_WMC    nAdvancedEncodeOpt;
    U32_WMC    nAdvancedEncodeOpt2;
...
//#ifdef WMC_NO_BUFFER_MODE
    ...
    U16_WMC     u16ExtnDataSize;
    // ++ Will_Chen
    U32_WMC     dwAudFrameTime;
    //U32_WMC     dwAudioBSOffset;
    //U32_WMC     dwAudioBSStart;
    //U32_WMC     dwAudioBSEnd;
    //U32_WMC     dwAudioBlockLeft;
    //U32_WMC     dwAudioPayLoadLeft;
    // -- Will_Chen
//#endif
...
typedef struct tVideoPayloadInfo {
    U32_WMC     dwPayloadOffset;
...
//  U8_WMC     *pVideoBuffer;
    ...
    U8_WMC     bVideoBuffer[MIN_WANTED*2+10];
    Bool_WMC   bInitStage; 
    U32_WMC    cbUsed;
    U32_WMC    dwFrameSize; 
    U32_WMC    cbFrame;
    ...
    // Will Add
    VIDEOPAYLOADINFO    PayloadInfo[1024];
    U32_WMC    dwPayloadNum;
    U32_WMC    dwTotalPayloadSize;
    // End Will Add
