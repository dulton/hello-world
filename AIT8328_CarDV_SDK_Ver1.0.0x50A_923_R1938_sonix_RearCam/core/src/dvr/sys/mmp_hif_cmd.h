...
#define     GET_IBC_LINK_ATTR                       SUB(0x14)
...
#define     SET_FETCH_RANGE                         SUB(0x06)
#define     SET_RAWSTORE_ONLY                       SUB(0x07)

/* FlowControl : IVA */
#define HIF_FCTL_CMD_FDTC		           	(GRP_FLOWCTL | FUNC(0x18))
...
#define HIF_FCTL_CMD_VMD                    (GRP_FLOWCTL | FUNC(0x19))
...
#define HIF_FCTL_CMD_ADAS                   (GRP_FLOWCTL | FUNC(0x1A))
...
#define     VIDPARAM_VIDEO_YUVITL_ENABLE            SUB(0x66)
...
#define     MERGER_DUALENC_START                    SUB(0x0D)
#define     MERGER_DUALENC_STOP                     SUB(0x0E)
...
#define     MERGER_DUALENC_ENABLE                   SUB(0x1A)
#define     MERGER_ALL_START                        SUB(0x1B)
#define     MERGER_UVCRECD_OPEN_FILE				SUB(0x1C)
