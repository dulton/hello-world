...
//------------------------------------------------------------------------------
//  Function    : MMPS_I2cm_SetRxTimeout
//  Description : ulTimeOut = 0 ==> no Timeout, otherwise the unit is millisecond
//------------------------------------------------------------------------------
/**
 ...
 @return the status of the operation.
*/
MMP_ERR MMPS_I2cm_SetRxTimeout(MMP_I2CM_ATTR *attr, MMP_ULONG ulTimeOut)
{
	return MMPD_I2cm_SetRxTimeout(attr, ulTimeOut);
}
