...
//------------------------------------------------------------------------------
//  Function    : MMPD_VIDPLAYER_SetYUVInterlance
//  Description :
//------------------------------------------------------------------------------
/** @brief Enable/Disable YUVInterlance
...
MMP_ERR MMPD_VIDPLAYER_SetYUVInterlance(MMP_BOOL bEnable)
{
    ...
    MMPH_HIF_SendCmd(GRP_IDX_VID, HIF_VID_CMD_VIDPLAY_OTHER | VIDPARAM_VIDEO_YUVITL_ENABLE);
    MMPH_HIF_ReleaseSem(GRP_IDX_VID);
    return MMP_ERR_NONE;
}
