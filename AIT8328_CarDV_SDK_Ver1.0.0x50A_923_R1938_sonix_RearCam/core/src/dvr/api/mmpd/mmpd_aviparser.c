...
MMP_ERR MMPD_AVIPSR_Predecode(MMP_BOOL bCardMode,MMP_BOOL bDecodeAudio, MMP_ULONG *sample_rate)
{
	return MMP_ERR_NONE;
}

MMP_ERR MMPD_AVIPSR_SeekByTime(const MMP_ULONG ulTime,MMP_BOOL bCardMode, MMP_BOOL bSeekToPrecisePos, MMP_BOOL bSeekToNextKeyFrame)
{
	return MMP_ERR_NONE;
}
