...
/** 
    ...
    @return MMP_ERR_NONE
*/
MMP_ERR	MMPD_AUI_SetPlayFormat(MMPD_AUDIO_DECODE_FMT decodefmt)
{
	MMPH_HIF_WaitSem(GRP_IDX_AUD, 0);
	// add for AUI and Audio player
	MMPH_HIF_SetParameterL(GRP_IDX_AUD, 0, 1);
...
/** 
    ...
    @return MMP_ERR_NONE
*/
MMP_ERR	MMPD_AUI_SetParseFormat(MMPD_AUDIO_DECODE_FMT decodefmt)
{
    MMPH_HIF_WaitSem(GRP_IDX_AUD, 0);
    // add for AUI and Audio player
    MMPH_HIF_SetParameterL(GRP_IDX_AUD, 0, 1);
...
/** 
    ...
    @return MMP_ERR_NONE
*/
MMP_ERR MMPD_AUI_GetMP3FileInfo(MMPD_AUDIO_MP3_INFO *mp3info)
{	
	MMPH_HIF_WaitSem(GRP_IDX_AUD, 0);
	MMPH_HIF_SetParameterL(GRP_IDX_AUD, 0, 1);
...
/** 
    ...
    @return MMP_ERR_NONE
*/
MMP_ERR MMPD_AUI_ReadMP3FileInfo(MMPD_AUDIO_MP3_INFO *mp3info)
{
...
/**
    ...
    @return MMP_ERR_NONE
*/
MMP_ERR MMPD_AUI_GetWAVFileInfo(MMPD_AUDIO_WAV_INFO *wavinfo)
{
	MMPH_HIF_WaitSem(GRP_IDX_AUD, 0);
	// add for AUI and Audio player
	MMPH_HIF_SetParameterL(GRP_IDX_AUD, 0, 1);
...
/** 
    ...
    @return MMP_ERR_NONE
*/
MMP_ERR MMPD_AUI_ReadWAVFileInfo(MMPD_AUDIO_WAV_INFO *wavinfo)
{
