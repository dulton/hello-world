...
*/
MMP_ERR MMPD_AUDPSR_InitMP3HeaderParseInfo(MMPD_AUDIO_MP3_INFO *mp3info)
{
#if (MP3_HOST_PARSER_EN == 1)
    MEMSET(mp3info, 0, sizeof(MMPD_AUDIO_MP3_INFO));
...
*/
MMP_LONG MMPD_AUDPSR_ParseMP3FrameHeader(MMPD_AUDIO_MP3_INFO *mp3Info, MMP_UBYTE *buf, MMP_LONG *framesize)
{
#if (MP3_HOST_PARSER_EN == 1)
	MMP_LONG verIdx;
...
@retval 0 Success.
*/
static MMP_LONG MMPD_AUDPSR_ParseWMAHeader(MMPD_AUDIO_WMA_INFO* wmainfo, MMP_LONG *lAudioStream)
{
...
static MMP_LONG MMPD_AUDPSR_GetOGGMetaData(MMPD_AUDIO_OGG_INFO *ogginfo)
{
...
@retval 0 Success.
*/
static MMP_ERR MMPD_AUDPSR_ParseWAVHeader(MMPD_AUDIO_WAV_INFO* wavinfo)
{
...
*/
#if 0
static MMP_ERR MMPD_AUDPSR_ParseAMRHeader(MMPD_AUDIO_AMR_INFO* amrinfo)
{
...
@retval MMP_ERR_NONE Success.
*/
MMP_ERR MMPD_AUDPSR_GetMp3Info(MMPD_AUDIO_MP3_INFO *mp3info)
{
#if (MP3_HOST_PARSER_EN == 1)
...
@retval MMP_ERR_NONE Success.
*/
MMP_ERR MMPD_AUDPSR_GetWMAInfo(MMPD_AUDIO_WMA_INFO *wmainfo)
{
#if (WMA_HOST_PARSER_EN == 1)
    MMP_LONG	ret;
    ...
    MEMSET(wmainfo, 0, sizeof(MMPD_AUDIO_WMA_INFO));
...
@retval MMP_ERR_NONE Success.
*/
MMP_ERR MMPD_AUDPSR_GetAACPlusInfo(MMPD_AUDIO_AACPLUS_INFO *aacplusinfo)
{
#if (AAC_HOST_PARSER_EN == 1)
...
@retval MMP_ERR_NONE Success.
*/
MMP_ERR MMPD_AUDPSR_GetWAVInfo(MMPD_AUDIO_WAV_INFO *wavinfo)
{
#if (WAV_HOST_PARSER_EN == 1)
    MMP_ERR ret;
    
    MEMSET(wavinfo, 0, sizeof(MMPD_AUDIO_WAV_INFO));
...
@retval MMP_ERR_NONE Success.
*/
MMP_ERR MMPD_AUDPSR_GetOGGInfo(MMPD_AUDIO_OGG_INFO *ogginfo)
{
#if (OGG_HOST_PARSER_EN == 1)
	MMP_LONG	res;

	MEMSET(ogginfo, 0, sizeof(MMPD_AUDIO_OGG_INFO));
...
@retval MMP_ERR_NONE Success.
*/
MMP_ERR MMPD_AUDPSR_GetRAInfo(MMPD_AUDIO_RA_INFO *rainfo)
{
#if (RA_HOST_PARSER_EN == 1)
...
@retval MMP_ERR_NONE Success.
*/
MMP_ERR MMPD_AUDPSR_GetAMRInfo(MMPD_AUDIO_AMR_INFO *amrinfo)
{
#if (AMR_HOST_PARSER_EN == 1)
	MMP_ERR ret;
    
    MEMSET(amrinfo, 0, sizeof(MMPD_AUDIO_AMR_INFO));
