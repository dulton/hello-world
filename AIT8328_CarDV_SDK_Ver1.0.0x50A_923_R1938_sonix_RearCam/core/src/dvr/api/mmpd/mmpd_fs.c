                                ...
                                MMP_BYTE *bMode, MMP_ULONG ulModeSize, MMP_ULONG *ulFileId)
{
	...
	if (mmpstatus) {
    	//RTNA_DBG_Str(0,"MMPD_FS_FileOpen Error or Search FileName Timeout");	
 ...
 *@warning      
  *@retval      SUCCESS - return MMP_ERR_NONE.
                FAIL    - return !=0. 
 */              
MMP_ERR MMPD_FORMATFREE_CheckMedia(void)
{
    return MMPF_FORMATFREE_CheckMedia(); 
}
...
MMP_ERR MMPD_FORMATFREE_Format(void)
{
    return MMPF_FORMATFREE_Format(); 
}
 ...
 *@warning      
  *@retval      SUCCESS - return MMP_ERR_NONE.
                FAIL    - return !=0.       
*/
MMP_ERR MMPD_FS_MakeFileDirEntry(FS_VOLUME * pVolume, const MMP_BYTE *pFileName, MMP_ULONG FileNUM ,MMP_ULONG FileSize, U64 FolderClusterNumber, U64 FileClusterNumber)
{
	return MMPF_FS_MakeFileDirEntry(pVolume, pFileName, FileNUM, FileSize, FolderClusterNumber, FileClusterNumber); 
}
