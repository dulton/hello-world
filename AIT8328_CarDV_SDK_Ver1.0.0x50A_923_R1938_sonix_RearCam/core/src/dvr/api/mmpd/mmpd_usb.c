...
//==============================================================================
//  Function    : MMPD_USB_CapturePCCam
//==============================================================================
/**
    @brief  PCCAM Capture
    @return MMP_ERR_NONE
*/
MMP_ERR MMPD_USB_CapturePCCam(void)
{
    MMPH_HIF_WaitSem(GRP_IDX_USB, 0);
    MMPH_HIF_SendCmd(GRP_IDX_USB, HIF_USB_CMD_PCCAM_CAPTURE);
    MMPH_HIF_ReleaseSem(GRP_IDX_USB);
    return MMP_ERR_NONE;
}
...
{
    return MMPF_USB_SetDropRxFrmCFG(ulTotalCnt, ulContinCnt, pDropRxFrmCallback);
}
