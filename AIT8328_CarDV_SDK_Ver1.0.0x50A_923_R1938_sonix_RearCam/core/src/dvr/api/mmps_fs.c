...
MMP_ERR MMPS_FORMATFREE_ConfigInfo( FormatFreeFolderConfig * pFolderConfig, MMP_BYTE FolderIndex, MMP_BYTE * FolderName, MMP_BYTE * FileNameInFolder )
{
 ...
 * @remarks               
 */
MMP_ERR MMPS_FORMATFREE_CheckMedia(void)
{
    return MMPD_FORMATFREE_CheckMedia(); 
}
 ...
 * @remarks               
 */
MMP_ERR MMPS_FORMATFREE_Format(void)
{
    return MMPD_FORMATFREE_Format();
}
