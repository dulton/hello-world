...
*/
MMP_ERR MMPS_AUI_InitializeMP3Play(MMPS_AUDIO_FILEINFO *fileinfo, MMPS_AUDIO_MP3_INFO *mp3info)
{
    MMP_ERR     status;
    ...
    MMPD_AUI_SetParseFormat(MMPD_AUDIO_MP3_PLAY);
    ...
    MMPD_AUI_GetMP3FileInfo((MMPD_AUDIO_MP3_INFO *)mp3info);
...
/**
    ...
    @endcode
*/
MMP_ERR MMPS_AUI_InitializeWAVPlay(MMPS_AUDIO_FILEINFO *fileinfo, MMPS_AUDIO_WAV_INFO *wavinfo)
{
    MMP_ERR     status;
	...
	if(playstatus != DECODE_OP_STOP) {
   	...
   	audiooutpath = MMPS_AUDIO_GetOutPath();
    MMPD_AUDIO_SetOutPath(audiooutpath);
    MMPD_AUI_SetPlayFormat(MMPD_AUDIO_WAV_PLAY);
    if (m_auiMediaPath == MMPS_AUI_MEDIA_PATH_CARD)
    ...
    MMPD_AUI_GetWAVFileInfo((MMPD_AUDIO_WAV_INFO *)wavinfo);
