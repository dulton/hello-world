 ...
 *
 */
tWMAFileStatus WMADec_WMAFileDecodeCreate (tHWMAFileState* phstate);
 ...
 *   cWMA_Failed               decoder Initialization failed 
 */
tWMAFileStatus WMADec_WMAFileDecodeInitEx (tHWMAFileState phstate, tWMA_U16 nDecoderFlags,
 ...
 */
 //hans
  //tWMAFileStatus WMAFileSetTargetMBRAudioStream (tHWMAFileState phstate, 
//                                                 tWMA_U16 wTargetAudioStream);
tWMAFileStatus WMADec_WMAFileSetTargetMBRAudioStream (tWMAFileHdrState *pstate, 
                                               tWMA_U16 wTargetAudioStream);
...
tWMAFileStatus WMADec_WMAFileDecodeInfo (tHWMAFileState hstate, tWMAFileHeader *hdr);
 ...
 */
tWMAFileStatus WMADec_WMAFileContentDesc (tHWMAFileState hstate, const tWMAFileContDesc **ppDesc);
...
tWMAFileStatus WMADec_WMAFileExtendedContentDesc (tHWMAFileState hstate, const tWMAExtendedContentDesc **pECDesc);
...
tWMAFileStatus WMADec_WMAFileDecodeData (tHWMAFileState hstate, tWMA_U32 *pnDecodedSamples);
...
tWMA_U32 WMADec_WMAFileGetPCM (tHWMAFileState hstate,
    tWMA_I16 *pi16Channel0, tWMA_I16 *pi16Channel1,
...
tWMAFileStatus WMADec_WMAFileSeek (tHWMAFileState hstate, tWMA_U32 msSeek, tWMA_U32 *pmsActual);
...
void WMADec_auMallocSetState(const MEMALLOCSTATE maState, void *pBuf, const tWMA_U32 nBufSize);


/* ===========================================================================
 * WMADec_SetWorkingBuf
--------------------------------------------------------------------------- */
int WMADec_SetWorkingBuf(int *buf);
