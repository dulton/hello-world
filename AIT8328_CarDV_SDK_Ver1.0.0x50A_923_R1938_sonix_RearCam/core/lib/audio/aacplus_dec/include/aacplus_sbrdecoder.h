...
typedef struct
{
  Word32  elementID;     /*!< ID_SCE (mono) or ID_CPE (stereo) */
  Word32  extensionType; /*!< e.g. SBR_EXTENSION or SBR_EXTENSION_MPEG */
  Word32  sizePayload;   /*!< length of data */
...
SBRDECODER AACPLUS_openSBR (Word32 sampleRate, Word16 samplesPerFrame, Flag bDownSample, Flag bApplyQmfLp) ;
