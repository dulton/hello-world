...
Word32 ffr_sqrt(Word32 op);
void   ffr_add_MantExp(Word32 a_m, Word32 a_e,  Word32 b_m, Word32 b_e,  Word16 *ptrSum_m, Word16 *ptrSum_e);
...
Word16 ffr_divide16_1(Word32 divident, Word32 divisor);
