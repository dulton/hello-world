...
Word32 CBlock_Quantize(Word32 value, Word32 scfMod, Word32 scale);

Word16 CBlock_GetEscape(HANDLE_BIT_BUF bs, const Word16 q);
Word16 CBlock_GetQuantExponent(Word32 value, Word32 scfMod);
Word32 CBlock_UnpackIndex(Word32 idx, Word16 *qp, const CodeBookDescription *hcb);
Word32 CBlock_DecodeHuffmanWord(HANDLE_BIT_BUF bs, const Word16 (*CodeBook) [HuffmanEntries]);
...
void Lap1(Word32 *coef, Word16 *prev, Word16 *out, const Word32 *window, Word32 cuScale, Word32 size, Word32 stride);
void Lap2(Word32 *coef, Word32 *prev, Word16 *out, const Word32 *window, Word16 cuScale, Word16 size, Word16 stride);
