...
#ifndef WMA_TARGET_MACOS
//#    include <tchar.h>//hans
#endif

typedef char TCHAR;//hans
...
extern "C" {
 ...
 // void wfioDelete(WavFileIO *pwfio);
   ...
   */
  I32 wfioOpen(WavFileIO *pwfio, const TCHAR *szFile, WAVEFORMATEXTENSIBLE *pFormat, U32 cbFormat, I32 mode);
  I32 prvwfioReWriteHeaders(WavFileIO *pwfio, WAVEFORMATEXTENSIBLE *pFormat, U32 cbFormat);
  ...
  I32 prvwfioSeekRaw(WavFileIO *pwfio, I32 position, I32 origin);
