...
/*
 * ra_depack_get_current_time
 *
 * Get current play time.
 */
UINT32 ra_depack_get_current_time(ra_depack* pDepack, UINT32 ulSubStream);


/*
 * ra_depack_clear_keytime
 *
 * Clear key time.
 */
HX_RESULT ra_depack_clear_keytime(ra_depack* pDepack, UINT32 ulSubStream);


/*
 * ra_depack_decode_frame
 *
 * Decode one realaudio frame.
 */
HX_RESULT ra_depack_decode_frame(ra_depack* pDepack, UINT32 ulSubStream, rm_packet* pPacket);
