...
void Int_lpc_1and3_2 (
    Word16 lsp_old[],  // i : LSP vector at the 4th subfr. of past frame (M) 
    Word16 lsp_mid[],  // i : LSP vector at the 2nd subframe of present frame (M)
    Word16 lsp_new[],  // i : LSP vector at the 4th subframe of present frame (M)
    Word16 Az[]        // o :interpolated LP parameters in subframes 1 and 3 (AZ_SIZE)                     
);
*/
/*
**************************************************************************
*
*  Function    : Dec_Int_lpc_1to3
*  Purpose     : Interpolates the LSPs and converts to LPC parameters 
*                to get a different LP filter in each subframe.
*  Description : The 20 ms speech frame is divided into 4 subframes.
