...
------------------------------------------------------------------------------*/
    ...
    //swyang
    int VC1DecDecodeRCV(unsigned char *stream, unsigned int strmLen, VC1DecMetaData *metaData);
    VC1DecRet VC1DecGetFreeFrame(VC1DecInst decInst, unsigned int *ulFrameAddr);
/*------------------------------------------------------------------------------
