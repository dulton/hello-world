...
typedef MMPD_AUDIO_WNR_CFG MMPS_AUDIO_WNR_CFG;
#endif
...
typedef enum _MMPS_AUDIO_UINT_ID {
	MMPS_AUDIO_INTERNAL_CODEC = 0,
	MMPS_AUDIO_EXTERNAL_CODEC,
	MMPS_AUDIO_HDMI
} MMPS_AUDIO_UINT_ID;

typedef enum _MMPS_AUDIO_RECORD_CMD_TYPE {
	MMPS_AUDIO_RECORD_CMD_START = 0,
	MMPS_AUDIO_RECORD_CMD_PAUSE,
	MMPS_AUDIO_RECORD_CMD_RESUME,
	MMPS_AUDIO_RECORD_CMD_STOP
} MMPS_AUDIO_RECORD_CMD_TYPE;
...
{
    MMPS_AUDIO_I2S_MASTER = 0,      ///< master mode
    MMPS_AUDIO_I2S_SLAVE            ///< slave mode
} MMPS_AUDIO_I2S_FORMAT;

typedef enum _MMPS_AUDIO_EXTCODEC_PATH
{
    MMPS_AUDIO_EXT_SPK_OUT = 0,     ///< speaker output path
    MMPS_AUDIO_EXT_HP_OUT,          ///< headphone output path
    MMPS_AUDIO_EXT_MIC_IN,          ///< mic in path
    MMPS_AUDIO_EXT_AUX_IN,          ///< AUX in path
    MMPS_AUDIO_EXT_MIC_BYPASS_SPK,  ///< mic in bypass to speaker out
    MMPS_AUDIO_EXT_MIC_BYPASS_HP,   ///< mic in bypass to headphone out
    MMPS_AUDIO_EXT_AUX_BYPASS_SPK,  ///< AUX in bypass to speaker out
    MMPS_AUDIO_EXT_AUX_BYPASS_HP,   ///< AUX in bypass to headphone out
    MMPS_AUDIO_EXT_MIC_IN_SPK_OUT,  ///< mic in and speaker out
    MMPS_AUDIO_EXT_MIC_IN_HP_OUT,   ///< mic in and headphone out
    MMPS_AUDIO_EXT_AUX_IN_SPK_OUT,  ///< AUX in and speaker out
    MMPS_AUDIO_EXT_AUX_IN_HP_OUT,   ///< AUX in and headphone out
    MMPS_AUDIO_EXT_PATH_MAX
} MMPS_AUDIO_EXTCODEC_PATH;
...
typedef enum _MMPS_AUDIO_I2S_WORK_MODE {
    MMPS_AUDIO_I2S_WORK_MODE_NONE = 0,
    MMPS_AUDIO_I2S_MASTER_MODE,             ///< BCK & LRCK is outputed by AIT
    MMPS_AUDIO_I2S_SLAVE_MODE,              ///< BCK & LRCK is outputed by external codec
    MMPS_AUDIO_I2S_MAX_WORK_MODE
} MMPS_AUDIO_I2S_WORK_MODE;

typedef enum _MMPS_AUDIO_I2S_MCLK_MODE {
    MMPS_AUDIO_I2S_MCLK_MODE_NONE = 0,
    MMPS_AUDIO_I2S_128FS_MODE,              ///< 128*fs clock output
    MMPS_AUDIO_I2S_192FS_MODE,              ///< 192*fs clock output
    MMPS_AUDIO_I2S_256FS_MODE,              ///< 256*fs clock output
    MMPS_AUDIO_I2S_384FS_MODE,              ///< 384*fs clock output
    MMPS_AUDIO_I2S_512FS_MODE,              ///< 512*fs clock output
    MMPS_AUDIO_I2S_768FS_MODE,              ///< 768*fs clock output
    MMPS_AUDIO_I2S_1024FS_MODE,             ///< 1024*fs clock output
    MMPS_AUDIO_I2S_1536FS_MODE,             ///< 1536*fs clock output
    MMPS_AUDIO_I2S_FIX_256FS_MODE,          ///< fixed 256*fs clock output
    MMPS_AUDIO_I2S_USB_MODE,                ///< fixed clock output
    MMPS_AUDIO_I2S_MAX_MCLK_MODE
} MMPS_AUDIO_I2S_MCLK_MODE;

typedef enum _MMPS_AUDIO_I2S_OUT_BITS {
    MMPS_AUDIO_I2S_OUT_BITS_NONE = 0,
    MMPS_AUDIO_I2S_OUT_16BIT,               ///< 16 bits for each channel
    MMPS_AUDIO_I2S_OUT_24BIT,               ///< 24 bits for each channel
    MMPS_AUDIO_I2S_OUT_32BIT,               ///< 32 bits for each channel
    MMPS_AUDIO_I2S_MAX_OUT_BIT_MODE
} MMPS_AUDIO_I2S_OUT_BITS;

typedef enum _MMPS_AUDIO_I2S_IN_BITS {
    MMPS_AUDIO_I2S_IN_BITS_NONE = 0,
    MMPS_AUDIO_I2S_IN_16BIT,                ///< 16 bits for each channel
    MMPS_AUDIO_I2S_IN_20BIT,                ///< 20 bits for each channel
    MMPS_AUDIO_I2S_MAX_IN_BIT_MODE
} MMPS_AUDIO_I2S_IN_BITS;

typedef enum _MMPS_AUDIO_I2S_WS_POLARITY {  ///< word select polarity
    MMPS_AUDIO_I2S_LRCK_POLARITY_NONE = 0,
    MMPS_AUDIO_I2S_LRCK_L_LOW,              ///< L channel is low, R channel is high
    MMPS_AUDIO_I2S_LRCK_L_HIGH,             ///< L channel is high, R channel is low
    MMPS_AUDIO_I2S_MAX_WS_POLARITY
} MMPS_AUDIO_I2S_WS_POLARITY;

typedef enum _MMPS_AUDIO_I2S_DELAY_MODE {
    MMPS_AUDIO_I2S_OUT_DELAY_NONE = 0,
    MMPS_AUDIO_I2S_OUT_DELAY_I2S,           ///< I2S mode output data delay
    MMPS_AUDIO_I2S_OUT_DELAY_STD,           ///< standard mode output data delay
    MMPS_AUDIO_I2S_MAX_OUT_DELAY_MODE
} MMPS_AUDIO_I2S_DELAY_MODE;
...
typedef struct _MMPS_AUDIO_I2S_CFG {
    MMPS_AUDIO_I2S_WORK_MODE    workingMode;                ///< working in master or slave mode
    MMPS_AUDIO_I2S_MCLK_MODE    mclkMode;                   ///< N*fs or USB mode
    MMPS_AUDIO_I2S_OUT_BITS     outputBitSize;              ///< output data bit size per channel
    MMPS_AUDIO_I2S_IN_BITS      inputBitSize;               ///< input data bit size
    MMPS_AUDIO_I2S_WS_POLARITY  lrckPolarity;               ///< LRCK polarity
    MMPS_AUDIO_I2S_DELAY_MODE   outDataDelayMode;           ///< output data delay mode
...
typedef enum _MMPS_AUDIO_ENCODE_FMT
{
    MMPS_AUDIO_VAMR_ENCODE = 0,     ///< video + amr encode mode
    MMPS_AUDIO_VAAC_ENCODE = 1,     ///< video + aac encode mode
    MMPS_AUDIO_AMR_ENCODE = 2,      ///< pure amr encode mode
    MMPS_AUDIO_AAC_ENCODE = 3,      ///< pure aac encode mode
    MMPS_AUDIO_MP3_ENCODE = 4,      ///< pure mp3 encode mode
    MMPS_AUDIO_WAV_ENCODE = 5,      ///< pure wav encode mode
    MMPS_AUDIO_VADPCM_ENCODE = 6,   ///< video + adpcm encode mode
    MMPS_AUDIO_VMP3_ENCODE = 7,     ///< video + mp3 encode mode
    MMPS_AUDIO_G711_ENCODE = 8,     ///< G711 mu law encode mode
    MMPS_AUDIO_VPCM_ENCODE = 9,     ///< video + raw PCM encode mode
    MMPS_AUDIO_PCM_ENCODE = 10
} MMPS_AUDIO_ENCODE_FMT;
...
MMP_ERR MMPS_AUDIO_InitRecord(MMPS_AUDIO_MEDIA_PATH MediaPath,MMPS_AUDIO_FILEINFO *fileinfo, MMPS_AUDIO_ENCODE_FMT fmt,MMP_ULONG mode, MMP_ULONG ulMaxSize);
