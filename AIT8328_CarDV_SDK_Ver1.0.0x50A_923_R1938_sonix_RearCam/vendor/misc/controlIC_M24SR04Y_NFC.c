...
MMP_ERR M24SR_I2cm_WriteBurstData( MMP_UBYTE* pbyData, MMP_USHORT usDataCnt, MMP_BOOL bSW_I2C )
{
    ...
    else
    {
        ...
        status = MMPF_I2cm_WriteBurstData( &gI2cmAttribute_M24SR04Y_NFC, usReg, pusCommandData, (MMP_UBYTE)(usDataCnt-1) );
    }
    return status;
...
static MMP_ERR M24SR_Deselect ( void )
{
    ...
    gI2cmAttribute_M24SR04Y_NFC.ubRegLen = 8;
    status = MMPF_I2cm_WriteBurstData(&gI2cmAttribute_M24SR04Y_NFC, usReg, usCRC, 2);
